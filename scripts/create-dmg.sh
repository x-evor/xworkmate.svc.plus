...
#
# Env:
#   DMG_VOLUME_NAME        default: CFBundleName (or "XWorkmate")
...
APP_NAME=$(/usr/libexec/PlistBuddy -c "Print CFBundleName" "$APP_PATH/Contents/Info.plist" 2>/dev/null || echo "XWorkmate")
